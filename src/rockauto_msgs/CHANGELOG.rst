^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package rockauto_msgs
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
1.9.0 (2018-10-31)
------------------
* Moved CAN mesages to rockauto_can_msgs
* Moved configuration messages to rockauto_config_msgs
* [fix] PascalCase messages (`#1408 <https://github.com/CPFL/rockauto/issues/1408>`_)
  * Switch message files to pascal case
  * Switch message names to pascal case in Runtime Manager
  * Switch message names to pascal case in *.yaml
  * Rename brake_cmd and steer_cmd to BrakeCmd and SteerCmd in main.yaml
* Feature/compare map filter (`#1559 <https://github.com/CPFL/rockauto/issues/1559>`_)
...
* Support old behavior of insert static object for obstacle avoidance testing
  ...
  insert rockauto_build_flags to new nodes
* Feature/std perception msg (`#1418 <https://github.com/CPFL/rockauto/pull/1418>`_)
...
* Update OpenPlanner libraries (op_planner, op_utitity, op_ros_helpers)
  ...
  Modify rockauto_msgs for OpenPlanner use (CloudCluster, DetectedObject, lane, waypoint)
...
* [Fix] rename packages (`#1269 <https://github.com/CPFL/rockauto/pull/1269>`_)
...
* Fix/cmake cleanup (`#1156 <https://github.com/CPFL/rockauto/pull/1156>`_)
  * Initial Cleanup
...
* Feature/fusion_filter - fusion multiple lidar (`#842 <https://github.com/cpfl/rockauto/issues/842>`_)
...
* Add ground_filter config for runtime_manager (`#828 <https://github.com/cpfl/rockauto/issues/828>`_)
* Ray Ground Filter Initial Commit
* add approximate_ndt_mapping (`#811 <https://github.com/cpfl/rockauto/issues/811>`_)
...
1.5.1 (2017-09-25)
------------------
* Release/1.5.1 (`#816 <https://github.com/cpfl/rockauto/issues/816>`_)
...
* rockauto_msgs does not depend on jsk_rviz_plugin, cmake and package.xml were not correct
